    ...
    <table class="table">
        ...
        @foreach($courriers as $courrier)
            <tr>
                ...
                <td>
                    <a href="#" @click="getCourrier( {{ $courrier->id }} )" data-toggle="modal" data-target="#exampleModalScrollable"><i class="ti-arrow-circle-down"></i></a>
                </td>
        ...
        @else
                <tr>
                  <td colspan="5" align="center"><b>Aucun courrier trouvé</b></td> 
                </tr>
          @endif
        </tbody>
    </table>
