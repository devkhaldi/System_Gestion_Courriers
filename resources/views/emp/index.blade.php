    ...
    <div class="container-fluid">
      ...
      <div class="col-md-12">
        <table class="table table-striped" style="margin-bottom:30px">
          ...
          <tbody>
          @if(count($courriersnonvues))
            @foreach($courriersnonvues as $courrier)
                <tr>
                    <td>{{ $courrier->num }}</td>
          ...
          @else
                <tr>
                  <td colspan="5" align="center"><b>Pas courriers pour le moment</b></td> 
                </tr>
          @endif
          </tbody>
      </table>
      ...
      <div class="col-md-12">
        <div class="delimiter"><span class="text">Courriers vues</span></div>
      </div>
      <div class="col-md-12">
        <table class="table table-striped">
          ...
          <tbody>
          @if(count($courriersvues))
            @foreach($courriersvues as $courrier)
                <tr>
                    <td>{{ $courrier->num }}</td>
                    <td>{{ $courrier->titre }}</td>
                    <td>{{ $courrier->emetteur }}</td>
